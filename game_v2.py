...
class CuartaFase:
    ...
    def mostrar_info_cuarta_fase(self):
        print("\n¡Increíble! Has llegado a la cuarta fase. Nada es lo que parece, estás a punto de ganar un viaje o algunas de las ciudades por las que estás compitiendo. O tal vez... tendrás que pagarlo sin disfrutarlo. ¡La decisión es tuya!")
    ...
    def resultado_final(self, decision):
        if decision:
            print("\n¡Felicidades! Has decidido arriesgarte y descubrir tu destino. ¡Prepárate para la sorpresa!")


            print("\nOpciones:")
            print("1. Disfrutar de tu premio actual.")
            print("2. Continuar jugando, perdiendo el premio actual, ¡quién sabe qué te espera!")
            ...
            if eleccion == "1":
                ...
                reproducir_cancion(canciones[self.ciudades_elegidas[0]], duracion=5)  
            elif eleccion == "2":
                print("\nHas decidido continuar jugando. Pierdes el premio actual, pero quién sabe qué emocionantes destinos te esperan. ¡Buena suerte!")
                ...
                print(f"\nRobot Jefe: '¡{self.nombre_viajero}! ¡Qué pena que seas humano! Pero como te has arriesgado, te dejaré concursar en nuestro mundo. ¡Adelante, sigue concursando!'")
            else:
